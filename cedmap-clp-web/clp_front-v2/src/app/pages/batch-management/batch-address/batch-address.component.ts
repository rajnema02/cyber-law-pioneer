...
@Component({
  selector: 'app-batch-address',
  templateUrl: './batch-address.component.html',
  styleUrls: ['./batch-address.component.scss']
})
export class BatchAddressComponent implements OnInit {
