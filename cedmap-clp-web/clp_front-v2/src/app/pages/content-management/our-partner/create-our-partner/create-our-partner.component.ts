...
@Component({
  selector: 'app-create-our-partner',
  templateUrl: './create-our-partner.component.html',
  styleUrls: ['./create-our-partner.component.scss']
})
export class CreateOurPartnerComponent implements OnInit {
  name: any;
  image: any;
  image1: any;
  image2: any;
  ...
  submit(frm: NgForm) {
    ...
    if (f.invalid) {
      ...
      this.api.post("partner", formData).subscribe((resp: any) => {
        if (resp) {
          console.log(resp);
          alert("partner created successfully");
          this.router.navigate(["/content/partner-list"]);
        }
      });
    }
  }
