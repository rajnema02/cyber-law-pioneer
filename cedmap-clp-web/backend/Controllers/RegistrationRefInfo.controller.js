const Model = require('../Models/RegistrationRefInfo.model')
const createError = require('http-errors')
const mongoose = require('mongoose')
const ModelName = 'RegistrationRefInfo'
...
module.exports = {
    ...
    list: async (req, res, next) => {
        try {
            const { title, disabled, is_inactive, page, limit, sort , orderId} = req.query
